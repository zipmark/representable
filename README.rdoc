...
Using the +:as+ option allows you to include other representable objects.
  ...
  peter.to_json
  #=> {"forename":"Peter","surename":"Pan","origin":{"title":"Wonderland"}}
...
Heroes have features, special abilities that make them a superhero.
...
Ok, things start working out. Your hero has a name, an origin and a list of features so far. Why not allows adding friends to Peter - nobody wanna be alone!
